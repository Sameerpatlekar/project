...
[private]
private-instance ansible_host=${PRIVATE_IP} ansible_user=ubuntu ansible_ssh_private_key_file=/home/sameer/.ssh/my-key.pem ansible_ssh_common_args='-o StrictHostKeyChecking=no'
